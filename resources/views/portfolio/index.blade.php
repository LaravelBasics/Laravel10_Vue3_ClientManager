...
<style>
    ...
    .gray-bg {
        ...
        box-shadow: 0.625rem 0.625rem 1.25rem 0rem rgba(0, 0, 0, 0.3);
...
<div class="container mt-4">
    ...
    <div class="rounded-box">
        <div>
            <!-- <span style="color:rgb(255, 4, 4);">(´・ω・｀)？</span> -->
            ...
            <p class="gray-bg">
                私はゲーム（PSO2、ラチェット＆クランク、モンスターハンター、遊戯王）、アニメ、漫画が好きで、
                <br>
        ...
        <div>
            ...
            <h4>
                <i class="fa-solid fa-lightbulb" style="color: #f1c40f;"></i> 学習やキャリアの動機
            </h4>

            <p class="gray-bg">
                PC関係の職につきたいという思いから、プログラミングに興味を持ち、就労支援での学習や実習を通じてスキルを身につけています。
                <br>
        ...
        <div>
            ...
            <h4>
                <i class="fa-solid fa-pencil" style="color: #e67e22;"></i> 現在学習中の言語や環境
            </h4>

            <p class="gray-bg">
                <strong>プログラミング言語:</strong> PHP, HTML5, CSS3, JavaScript
                <br>
        ...
        <div>
            ...
            <p class="gray-bg">
                将来の目標はまだ明確に決まっていませんが、フロントエンドとバックエンド両方の技術を磨きながら、プロジェクトに活かしていきたいと考えています。
            </p>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="rounded-box">
            ...
            <h4>
                <strong>
                    <i class="fa-solid fa-gear" style="color: #2ecc71;"></i> 本社実習（株式会社リテラル）
                </strong>
                &ensp;8/19～9/19（1か月間）&ensp;&ensp;10～16時（休憩1時間）
            </h4>
        ...
        <div class="rounded-box">
            ...
            <h4>
                <strong>
                    <i class="fa-solid fa-cogs" style="color: #2ecc71;"></i> 外部実習
                </strong>
                &ensp;&ensp;&ensp;10/8~10/10（3日間）&ensp;&ensp;13～17時（小休憩自由）
            </h4>
    ...
    <h1 class="green-bg" id="section2">【Java課題制作】</h1>
    <div class="rounded-box">
        <!-- <div class="d-m-t"></div> -->
        <!-- <span style="color:rgb(255, 4, 4);">(´・ω・｀)？</span> -->

        <h4 id="section12">
            <i class="fa-solid fa-sitemap" style="color: #9b59b6; position: relative; top: 0.3rem;"></i> <button
                type="button" class="btn btn-link" @click="showHelpModal1"
        ...
        <p class="gray-bg">
            制作期間:1日
            <br>
            コード完成後（コメントアウトしている箇所）、職員からフィードバックを受けて、条件式の部分をメソッド化しました。
        </p>
    ...
    <div class="rounded-box">
        <!-- <div class="d-m-t"></div> -->
        <h4 id="section13">
            <i class="fa-solid fa-layer-group" style="color: #3498db; position: relative; top: 0.3rem;"></i> <button
                type="button" class="btn btn-link" @click="showHelpModal2"
        ...
        <p class="gray-bg">
            ...
            <br>
            また、研究問題【1】のコードは実行時間3秒（ひとつのメソッドにまとめ、呼ぶ回数を減らすと、2秒でした）
            <br>
    ...
    <h1 class="green-bg" id="section1" style="margin-bottom: 0;">【PHP課題制作】</h1>
    ...
    <div>
        ...
        <div class="rounded-box">
            ...
            <p class="gray-bg">
                このSNS風アプリでは、記事の投稿・編集やいいね <i class="fas fa-heart" style="color: red;"></i>
                、ユーザーフォローが行えます。
                <br>
                ...
                <br>
                <i class="fas fa-heart" style="color: #808080;"></i> を押すと「いいね <i class="fas fa-heart" style="color: red;"></i>」が付き、
                赤い状態でクリックすると逆に解除されます。
                <br>
                ※「いいね」の反映には5～6秒のタイムラグがある場合があります。
                <br>
        ...
        <div class="rounded-box">
            <div>
                ...
                <h3 id="section8">
                    <strong style="margin-right: 5rem;"><i class="fa-solid fa-book-open" style="color: #2ecc71;"></i> 本管理アプリ
                    </strong>
                </h3>
            </div>
        ...
        <div class="rounded-box">
            ...
            <a href="https://laravel10-vue3-client-manager.vercel.app/languages" target="_blank" style="font-size: 1.5rem;">
                <i class="fa-solid fa-desktop"></i> アプリの画面
            </a>

            <span style="margin-right: 5rem;"></span>

            <a href="https://github.com/LaravelBasics/Laravel10_Vue3_ClientManager/tree/master" target="_blank" style="font-size: 1.5rem;">
                <i class="fa-brands fa-github"></i> GitHub
            </a>
            ...
            <p class="gray-bg">
                このアプリでは、学習した日数やプログラミング言語に基づいた教材の管理を行います。
                <br>
                「学習した日数」一覧画面に移動後、プログラミング言語をセレクトボックスで選択し、
                <br>
                該当する教材をクリックすると、言語に紐づいた教材が取得されます（取得にはタイムラグがあります）。
                <br>
                <strong class="yellow" style="font-weight: bold;">※検索ボタンを空のままクリックすると、データベースから全件取得されます。</strong>
                <br>
                左側のサイドメニューから「顧客管理システム改修アプリ」をクリックすると、4つの画面にアクセスできます。
                <br>
                登録、編集、削除が行えるほか、バリデーション機能や、学習日数のソート機能（昇順・降順）が提供されています。
                <br>
                データ編集時、編集ボタンを押すと、バックエンドからフロントエンドにデータが渡され、編集画面で更新できます。
                <br>
                ...
                ※左のサイドメニュー: 顧客管理システム改修アプリをクリックすると、リンクから４つの画面にアクセスできます。<br>
            ...
            <p class="gray-bg">
                アプリ制作期間は1ヶ月で、その後1週間は既存コードの改修を行いました。
                <br>
                改修作業は実習後に行い、社外秘の情報が含まれていたため、職員に確認を取ったうえで、実習で作成したコードを基に新たな挑戦をしました。
                <br>
                元の仕様「親会社」に紐付く「子支社」を変更し、「プログラミング言語」に紐づく「教材」、「教材」に紐づく「学習日数」という新しい設計にしました。
                <br>
        ...
        <div class="rounded-box">
            <div>
                ...
                <h3 id="section10">
                    <strong style="margin-right: 5rem;"><i class="fa-solid fa-envelope" style="color: #2ecc71;"></i> 簡易お問い合わせフォームアプリ
                    </strong>
                </h3>
            </div>
            ...
            <a href="https://github.com/LaravelBasics/Laravel11_ContactForm/tree/master" target="_blank" style="font-size: 1.5rem;">
                <i class="fa-brands fa-github"></i> GitHub
            </a>
            ...
            <p class="gray-bg">
                このアプリでは、必須項目を入力し、「個人情報の取り扱いに同意する」にチェックを入れて、確認ボタンを押すと内容確認画面が表示されます。
                <br>
                その後、送信ボタンを押すと、管理者宛てにメールが送信されます。
                <br>
                送信後はサンクス画面が表示され、リンクをクリックすると最初の画面に戻ります。
                <br>
                レイアウトはシンプルで、最低限の機能のみを実装しています。
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 47.24rem;">
            <div class="modal-content" style="height: 23.622rem;">
                ...
                <div class="modal-body">
                    ...
                    <p>と表示してください。</p>
                    <strong>
                        <a href="https://github.com/LaravelBasics/java/blob/master/src/FizzBuzz7_1/FizzBuzz.java" target="_blank" style="font-size: 1.2rem;">
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 52.03rem;">
            <div class="modal-content" style="height: 37.80rem;">
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <h5>研究問題 【2】</h5>
                    100 * 100の世界の中に存在できる青森、鹿児島、三重の合計の最大の数と、その配置を求めてください
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 59.05rem;">
            <div class="modal-content" style="height: 37.80rem;">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        ５２枚のトランプを使用（ジョーカーはありません）
                        <br>
                        初めにディーラーがカードを2枚ずつ配ります。
                        <br>
                        ゲーム開始時、『ディーラー』の手は２枚のうち1枚だけ開示されます
                        <br>
                        『ディーラー』は『プレイヤー』に対してカードの追加を行うかを聞きます。
                        <br>
                        カードを追加する場合は、【１】を入力
                        <br>
                        手持ちの点数が十分だと思ったら、【０】を入力。その点数のままディーラーと勝負します。
                        <br>
                        カードは何枚でも追加できますが、21点を越えてしまうとその時点で『プレイヤー』の負けとなります。
                        <br>
                        『プレイヤー』が選択を終えた後、最後に『ディーラー』がカードをめくり、17点以上になるまでカードを引き続け、【勝負】となります。
                        <br>
                        『ディーラー』が22点以上になった場合は、『ディーラー』の負けとなり、『プレイヤー』が21点以下の場合勝利となります。
                        <br>
                        『ディーラー』よりも21点に近い場合、『プレイヤー』は勝ちとなり、逆に『ディーラー』よりも21点に遠い場合プレイヤーは負けとなります。
                        <br>
                        同点の場合は引き分けとなります。
                    </p>
                    <h5>【カードの数え方】</h5>
                    ...
                    <h5>【特別な役】</h5>
                    <p>
                        最初に配られた2枚のカードが「Aと10点札」で21点が完成していた場合を
                        <br>
                        『ブラックジャック』といい、片方のみの場合その時点で勝ちとなります。
                    </p>
    ...
    <div>
        ...
        <div class="rounded-box">
            ...
            <p class="gray-bg">
                10月1日〜1月19日: 教材ProgateのJava、就労支援カリキュラムのJava基礎、アルゴリズム、2次元配列、例外処理、ファイル入出力など（約4ヶ月）
                <!-- m-t2縦の行間変更 -->
                <br>
            ...
            <p class="gray-bg">
                2月15日〜3月14日: 教材Be EngineerのPHP基礎, アルゴリズム問題, 基礎15問, 応用15問
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                ...
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                4月&ensp;1日〜4月30日: <i class="fa-solid fa-file-word" style="color: #2b5797;">
            ...
            <h5 style="font-size: 1.2rem;">
                <i class="fab fa-laravel" style="color: #F65314;"></i> 2024年5月: Laravelの学習（XAMPP,composer,MySQLなど）
            </h5>

            <p class="gray-bg">
                5月20日〜6月24日: 教材Laravel 6基礎
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                6月25日〜7月&ensp;4日: 教材Techpit①メルカリ風フリマアプリ制作、
                ...
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                7月31日〜8月&ensp;5日: ProgateのJavaScript、Git、HTML&CSS
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                8月&ensp;6日〜8月&ensp;7日: JavaScriptによるDOM操作
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
            ...
            <h5 style="font-size: 1.2rem;">
                <i class="fa-solid fa-gear" style="color: #2ecc71;"></i> 2024年8月: プログラミング実習
            </h5>

            <p class="gray-bg">
                8月19日〜9月19日: 株式会社リテラルでの実習
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
            ...
            <p class="gray-bg">
                10月17日〜10月&ensp;5日: 就労支援の職員が制作中の教材をデバッグ。Docker学習。⑥Laravelでデプロイに挑戦。デプロイが成功したので職員へフィードバック
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
            ...
            <h5 style="font-size: 1.2rem;">
                <i class="fas fa-user-tie" style="color: black;"></i> 2024年10月: ポートフォリオ改良（就職活動、履歴書など）
            </h5>
            ...
            <p class="gray-bg">
                ...
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                11月&ensp;1日〜11月&ensp;7日: ポートフォリオの更新、②SNS風アプリの見直し、Vue.jsが本番で正常に動作するよう改善
                <br>
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                ...
                <span class="m-t2"></span>
                <span class="p-l2"></span>
                12月11日〜12月15日: 職員からのフィードバックを受けて、ポートフォリオのレイアウトを一新、ユーザーインターフェイスを考慮したデザインに改良。
            </p>
        </div>
        ...
        <div>
            ...
            <div class="r-b" style="text-align: center; margin-right: 1rem;">
